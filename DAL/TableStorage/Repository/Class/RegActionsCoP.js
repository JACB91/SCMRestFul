...
function getAllForPlacefun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.queryEntities('RegActionsCoP',Query, null, function(error, result, response){
                if(!error){
...
function insertFun(parameters){
    return new Promise(function(resolve, reject){
        tableService.createTableIfNotExists('RegActionsCoP', function(error,result, response){
            if(!error){
                tableServiceButtons.insertEntity('RegActionsCoP', parameters, function(error, result, response){
                    if(error){
                        return resolve(result.entries);
                    }else{
                        return reject(error);
...
function deleteFun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.deleteEntity('RegActionsCoP',Query, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
...
function updateOneByIdForPlacefun(parameters){
    return new Promise(function(resolve, reject){
        tableService.replaceEntity('RegActionsCoP',parameters, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
