...
var tableRegisterCaller = azure.createTableService(accountName, accountKey);
tableRegisterCaller.createTableIfNotExists('RegisterCaller', function(error,result, response){
    if(!error)
    {
