...
function getAllForPlacefun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.queryEntities('RegInnings',Query, null, function(error, result, response){
                if(!error){
...
function insertFun(parameters){
    return new Promise(function(resolve, reject){
        tableService.createTableIfNotExists('RegInnings', function(error,result, response){
            if(!error){
                tableService.insertEntity('RegInnings', parameters, function(error, result, response){
                    if(error){
                        return resolve(result.entries);
                    }else{
                        return reject(error);
...
function deleteFun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.deleteEntity('RegInnings',Query, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
...
function updateOneByIdForPlacefun(parameters){
    return new Promise(function(resolve, reject){
            tableService.replaceEntity('RegInnings',parameters, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
