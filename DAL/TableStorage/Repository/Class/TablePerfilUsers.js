...
var tablePerfilUsers = azure.createTableService(accountName, accountKey);
tablePerfilUsers.createTableIfNotExists('PerfilUsers', function(error,result, response){
    if(!error)
    {
