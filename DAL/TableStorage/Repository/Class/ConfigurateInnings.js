...
module.exports = ConfigurateInnings;
...
function getAllForPlacefun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.queryEntities('ConfigurateInnings',Query, null, function(error, result, response){
                if(!error){
...
function insertFun(parameters){
    return new Promise(function(resolve, reject){
        tableService.createTableIfNotExists('ConfigurateInnings', function(error,result, response){
            if(!error){
                tableService.insertEntity('ConfigurateInnings', parameters, function(error, result, response){
                    if(error){
                        return resolve(result.entries);
                    }else{
                        return reject(error);
...
function deleteFun(parameters){
    return new Promise(function(resolve, reject){
            ...
            tableService.deleteEntity('ConfigurateInnings',Query, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
...
function updateOneByIdForPlacefun(parameters){
    return new Promise(function(resolve, reject){
            tableServiceButtons.replaceEntity('ConfigurateInnings',parameters, null, function(error,result,response){
                if(!error){
                   return resolve(result.entries);
                }else{
                   return reject(error);
