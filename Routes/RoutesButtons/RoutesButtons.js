...
router.get('/api/Delete/:PartitionKey/:RowKey/:ID_Reference/:ID_Caller/:ID_Service/:ID_Close/:Ini_Date_Service/:Ini_Date_Caller/:End_Date_Service/:End_Date_Caller/:ActiveService/:ActiveCaller/:Innings/:Zone/:Place/:Pais/:ID_Pais/:ReCall_Call/:ReCall_Service/:Liable/:Type_Close_Call', function(req, res){
  var parameters = new buttonModel({
    PartitionKey      : String(req.params.PartitionKey),
    RowKey            : String(req.params.RowKey),
    ID_Reference 		  : String(req.params.ID_Reference),
...
router.get('/api/UpdateOneByIdForPlace/:PartitionKey/:RowKey/:ID_Reference/:ID_Caller/:ID_Service/:ID_Close/:Ini_Date_Service/:Ini_Date_Caller/:End_Date_Service/:End_Date_Caller/:ActiveService/:ActiveCaller/:Innings/:Zone/:Place/:Pais/:ID_Pais/:ReCall_Call/:ReCall_Service/:Liable/:Type_Close_Call', function(req, res){
  var parameters = new buttonModel({
    PartitionKey      : String(req.params.PartitionKey),
    RowKey            : String(req.params.RowKey),
    ID_Reference 		  : String(req.params.ID_Reference),
